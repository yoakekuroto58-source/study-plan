...
const GAS_URL = "https://script.google.com/macros/s/AKfycbyx408d9MOVIJnCAvD4E8PC77NlDENBKFKK2qzd4E_s5LoWHR8l4fUYDF-SLAXbkaX7/exec";
...
document.getElementById("practice-question").innerHTML = question.question;
...
if (!isRetryingWrongQuestions) {
    practiceWrongQuestions.push(
        ...
        result.innerHTML =
            ` 不正解！<br>正解は「${question.answer}」です。`;

        result.className =
            "practice-result incorrect-result";
    }
